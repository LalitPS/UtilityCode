...
public class DedupFileDataValidator {

	private ResultSet getCSIQueryResult(String query) throws SQLException,InstantiationException, IllegalAccessException,ClassNotFoundException, IOException {
	...
	public ArrayList<String[]> getQueryListResult(ArrayList<StringBuilder> queryBuilderList) throws SQLException,InstantiationException, IllegalAccessException,ClassNotFoundException, IOException {
	...
	public ArrayList<String[]> getQueryListResultFromCSI(
		...
		for (StringBuilder queryBuilder : queryList) {
			...
			String query = queryBuilder.toString();
			ResultSet resultSet = getCSIQueryResult(query);
			if (count == 1) {
				ResultSetMetaData metaData = resultSet.getMetaData();
				columncount = metaData.getColumnCount();
				String header[] = new String[columncount];

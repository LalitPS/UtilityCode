...
public class Constants {
	...
	public static String packageMigratedFilesPrefix = "USIDMigrationMigratedOrderReport";
	public static String packageImpactedFilesPrefix = "USIDMigrationImpactedOrderReport";
